...
gpg --show-keys --with-fingerprint --with-colons ./influxdata-archive.key 2>&1 && cat influxdata-archive.key | gpg --dearmor | sudo tee /etc/apt/keyrings/influxdata-archive.gpg > /dev/null
