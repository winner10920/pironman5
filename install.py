...
settings = {
    ...
    'python_source': {
        'pironman5': './',
        'pm_auto': f'git+https://github.com/winner10920/pm_auto.git@1.2.12',
    },
...
dashboard_settings = {
    ...
    'python_source': {
        'pm_dashboard': f'git+https://github.com/winner10920/pm_dashboard.git@1.2.10',
        'sf_rpi_status': f'git+https://github.com/winner10920/sf_rpi_status.git@1.1.0',
    },
}
